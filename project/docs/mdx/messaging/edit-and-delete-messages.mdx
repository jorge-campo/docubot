...
<Tabs defaultValue="Mobile">
  ...
  <TabsContent value="Desktop">
    1. From the navigation sidebar, click <ContextTag icon={<ChatDesktopIcon />}>Chat</ContextTag> or the community where you want to edit a message.
...
<Tabs defaultValue="Mobile">
  ...
  <TabsContent value="Desktop">
    1. From the navigation sidebar, click <ContextTag icon={<ChatDesktopIcon />}>Chat</ContextTag> or the community where you want to delete a message.
