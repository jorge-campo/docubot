...
<Tabs defaultValue="Mobile">
  ...
  <TabsContent value="Desktop">
    1. From the navigation sidebar, click <ContextTag icon={<ChatDesktopIcon />}>Chat</ContextTag>.
    ...
    1. Type the Status handle of the contact you want to invite and select them. Once you're done, click <ContextTag>Confirm</ContextTag>.
  </TabsContent>
</Tabs>
