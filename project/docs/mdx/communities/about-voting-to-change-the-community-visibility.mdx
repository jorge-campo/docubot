...
Votes happen on the [Community Directory Curation dApp](https://curate.status.app)<ExternalIcon />. This is an independent, decentralized application deployed on the [Optimism network](../getting-started/layer-2-scaling-solutions-for-ethereum.mdx) and is separate from the Status app.
