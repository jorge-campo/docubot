...
<Tabs defaultValue="Desktop">
  ...
  <TabsContent value="Desktop">
    ...
    1. In the new control node, click <ContextTag icon={<SettingsDesktopIcon />}>Settings</ContextTag> > <ContextTag icon={<LogOutDesktopIcon />}>Sign out and quit</ContextTag>.
    ...
    1. In the original control node, click <ContextTag icon={<SettingsDesktopIcon />}>Settings</ContextTag> > <ContextTag icon={<LogOutDesktopIcon />}>Sign out and quit</ContextTag>.
    1. Click <ContextTag>Sign out and quit</ContextTag> again to confirm.
