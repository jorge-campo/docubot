...
<Admonition type="info">
  Alongside the Ethereum blockchain, Status supports other [Layer-2 blockchain networks](./layer-2-scaling-solutions-for-ethereum.mdx) fully committed to decentralization, such as Optimism and Arbitrum.
</Admonition>
...
You can send, receive and store tokens securely, including Ether and [ERC-20 tokens](../wallet/understand-erc20-tokens.mdx), as well as assets from Ethereum [Layer-2 blockchains (L2s) and sidechains](./layer-2-scaling-solutions-for-ethereum.mdx).
