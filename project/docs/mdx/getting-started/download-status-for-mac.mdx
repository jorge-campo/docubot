...
1. Click <ContextTag>Beta for MacOS</ContextTag>.
...
To protect yourself from malware, viruses or scams, always download the Status app from a trusted source. For the Mac version, use the [Status website](https://status.app)<ExternalIcon />.
...
Download the Status app for Mac from the [Status website](https://status.app)<ExternalIcon />. If your Mac still shows a security message and you can't install the Status app, check the [Safely open apps on your Mac](https://support.apple.com/en-us/HT202491)<ExternalIcon /> Apple Support article for more information.
