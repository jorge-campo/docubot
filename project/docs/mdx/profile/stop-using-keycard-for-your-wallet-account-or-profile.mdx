...
<Tabs defaultValue="Desktop">
  ...
  <TabsContent value="Desktop">
    ...
    1. Open the Status app and, from the tab bar, click <ContextTag icon={<SettingsDesktopIcon />}>Settings</ContextTag> > <ContextTag icon={<KeycardDesktopIcon />}>Keycard</ContextTag> and select the Wallet account or profile under <ContextTag>Your Keycard(s)</ContextTag>.
