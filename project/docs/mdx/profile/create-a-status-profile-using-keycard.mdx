...
<Tabs defaultValue="Mobile">
  ...
  <TabsContent value="Mobile">
    ...
    1. Tap <ContextTag>Use an empty Keycard</ContextTag> and then tap <ContextTag icon={<KeycardIcon />}>Scan Keycard</ContextTag>. Hold or place your Keycard near the top (iPhone) or back (Android phones) of your phone.
